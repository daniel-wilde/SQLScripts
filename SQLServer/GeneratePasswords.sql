...
GO
CREATE PROCEDURE sp_help_revlogin2 @login_name sysname = NULL AS
...
BEGIN
  ...
  RETURN -1
END
SET @tmpstr = '/* sp_help_revlogin2 script '
PRINT @tmpstr
...
BEGIN
  ...
  BEGIN
    ...
    BEGIN -- NT authenticated account/group
      ...
      SET @tmpstr = 'IF NOT EXISTS (SELECT 1 FROM sys.syslogins WHERE name = N'''  + @name + ''')
BEGIN
